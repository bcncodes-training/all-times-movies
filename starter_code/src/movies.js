...
//crear turnHoursToMinutes

//require("./data.js");

/*function turnHoursToMinutes(peliculas) {
    let copiaPeliculas = peliculas.map()


}

let listaPeliculas = turnHoursToMinutes(movies);*/

//let newArr = movies.map((e)=> (e.duration));
var movies = [
    {
...
//Metodo .split no nos sirve para NADA!

/*let newArr = movies.map((e)=>(e.duration));

console.log(newArr);*/
// Esta variable nos devuelve una ARRAY DE OBJETOS!!!!con los datos de duration

//eliminar h
/*let newArr = movies.map((e)=> (e.duration.replace(/h|min/g, '')));//EMEPEZAR!!!!!!!!!

//Conseguido eliminar h y min. ¿cómo multiplico y sumo?
//y recuerda que no es una array solamente
/*utilizo la g para indicar que quiero cambiar + de un elemento en el string (g=global)
SIEMPRE se utiliza cuando se quiere cambiar mas de un  elemento en replace*/
...
for( i = 0; i < newArr.length; i++) {
  //utilizacion parseInt para convertir en num un string
  newArr2[i] = parseInt(newArr[i])*60 ;
...
console.log(newArr2);*/
 ...
 /* let newArr = movies.map((e)=> (e.durationHoras = e.duration.replace(/h/, ':')
   ));

console.log(newArr);*/


//sacar min y horas. comprobar
function turnHoursintoMinutes(moviesArray) {
  ...
  return moviesArray.map(elem =>{
    ...
    //return Object.assign({},elem,{duration:hours+mminutes})
  })
}
